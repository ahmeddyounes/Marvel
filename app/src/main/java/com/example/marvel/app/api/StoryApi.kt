...
class StoryApi(
    ...
    fun getAll(limit: Int, offset: Int): Call<MarvelResponse<StoryResponse>> {
    ...
    fun getById(id: Int): Call<MarvelResponse<StoryResponse>> {
        val timestamp = getTimestamp()
        val apiKey = getApiKey(timestamp)
    ...
    fun getAssociated(id: Int, limit: Int, offset: Int): Call<MarvelResponse<StoryResponse>> {
        val timestamp = getTimestamp()
        val apiKey = getApiKey(timestamp)
